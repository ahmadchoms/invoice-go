        ...
        <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4 py-12 dark:bg-gray-900">
            <Card className="w-full max-w-md">
                <CardHeader className="space-y-1">
                    ...
                    <CardDescription className="text-center">Buat akun untuk mulai mengelola invoice bisnis Anda</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input id="businessName" placeholder="Nama Perusahaan Anda" {...register("businessName")} />
                        ...
                        <SubmitButton className="w-full" isLoading={isLoading} loadingText="Memproses..." text="Daftar" />
                    </form>
